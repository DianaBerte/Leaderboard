...
export default function App() {
  ...
  console.log("playersState.players.content:", playersState.players.content)
  console.log("sortedPlayers:", sortedPlayers)

  // console.log("hello initialState.players.content 1:", initialState.players.content)  
  ...
  console.log("hello playersState:", playersState)
